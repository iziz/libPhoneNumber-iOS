...
code set to the parameters, countryCode and  languageCode.
*/
...
country code
* and national number attributes of the NBPhoneNumber parameter. If no result was found from
querying the geocoding databases,
* this method will return nil.
*
* This method assumes the validity of the NBPhoneNumber object passed in that it contains a
countryCode
* and nationalNumber attribute. This method prepares a select statement to search through a SQLite
database for the most accurate text description for the phone number parameter.
*
* @param phoneNumber  a valid phone number for which we want to get a text description
* @return  a text description for the given language code for the given phone number, or nil
* if a geocoding description couldn't be found in the SQLite databases.
*/
