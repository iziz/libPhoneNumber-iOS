...
- (void)testIsValidShortNumber {
  ...
  NBPhoneNumber *invalidWithRegion = [_phoneNumberUtil parse:@"123456" defaultRegion:@"FR" error:nil];
...
- (void)testIsCarrierSpecific {
  ...
  XCTAssertTrue([_shortNumberUtil isPhoneNumberCarrierSpecific:carrierSpecificForSomeRegion forRegion:@"US"]);
  XCTAssertFalse([_shortNumberUtil isPhoneNumberCarrierSpecific:carrierSpecificForSomeRegion forRegion:@"BB"]);
}
...
- (void)testExpectedCost {
  ...
  XCTAssertEqual(NBEShortNumberCostPremiumRate,
      [_shortNumberUtil expectedCostOfPhoneNumber:[_phoneNumberUtil parse:premiumRateSample defaultRegion:@"FR" error:nil]
                            forRegion:@"FR"]);
  ...
  // Standard rate.
  NSString *standardRateSample = [_testHelper exampleShortNumberForCost:NBEShortNumberCostStandardRate
                                                      regionCode:@"FR"];
  XCTAssertEqual(NBEShortNumberCostStandardRate,
      [_shortNumberUtil expectedCostOfPhoneNumber:[_phoneNumberUtil parse:standardRateSample defaultRegion:@"FR" error:nil]
                            forRegion:@"FR"]);
  ...
  XCTAssertEqual(NBEShortNumberCostStandardRate, [_shortNumberUtil expectedCostOfPhoneNumber:standardRateNumber
                                                                       forRegion:@"FR"]);
  ...
  XCTAssertEqual(NBEShortNumberCostTollFree,
      [_shortNumberUtil expectedCostOfPhoneNumber:[_phoneNumberUtil parse:tollFreeSample defaultRegion:@"FR" error:nil]
                            forRegion:@"FR"]);
  ...
  XCTAssertEqual(NBEShortNumberCostTollFree, [_shortNumberUtil expectedCostOfPhoneNumber:tollFreeNumber
                                                                   forRegion:@"FR"]);

  // Unknown cost.
  XCTAssertEqual(NBEShortNumberCostUnknown,
      [_shortNumberUtil expectedCostOfPhoneNumber:[_phoneNumberUtil parse:@"12345" defaultRegion:@"FR" error:nil]
                            forRegion:@"FR"]);
  ...
  XCTAssertEqual(NBEShortNumberCostUnknown, [_shortNumberUtil expectedCostOfPhoneNumber:unknownCostNumber
                                                                  forRegion:@"FR"]);

  // Test that an invalid number may nevertheless have a cost other than UNKNOWN_COST.
  NBPhoneNumber *invalidShortNumber = [_phoneNumberUtil parse:@"116123" defaultRegion:@"FR" error:nil];
  XCTAssertFalse([_shortNumberUtil isValidShortNumber:invalidShortNumber forRegion:@"FR"]);
  XCTAssertEqual(NBEShortNumberCostTollFree, [_shortNumberUtil expectedCostOfPhoneNumber:invalidShortNumber
                                                                   forRegion:@"FR"]);
  ...
  XCTAssertEqual(NBEShortNumberCostTollFree, [_shortNumberUtil expectedCostOfPhoneNumber:invalidShortNumber2
                                                                   forRegion:@"FR"]);
  ...
  XCTAssertEqual(NBEShortNumberCostUnknown, [_shortNumberUtil expectedCostOfPhoneNumber:unknownNumber2]);
}

- (void)testExpectedCostForSharedCountryCallingCode {
  NBShortNumberUtil *_shortNumberUtil = [[NBShortNumberUtil alloc] init];
  ...
  XCTAssertTrue([_shortNumberUtil isValidShortNumber:[_phoneNumberUtil parse:ambiguousPremiumRateString
                                       defaultRegion:@"AU"
  ...
  XCTAssertEqual(NBEShortNumberCostPremiumRate,
      [_shortNumberUtil expectedCostOfPhoneNumber:[_phoneNumberUtil parse:ambiguousPremiumRateString
                                    defaultRegion:@"AU"
                                            error:nil] forRegion:@"AU"]);
  XCTAssertFalse([_shortNumberUtil isValidShortNumber:[_phoneNumberUtil parse:ambiguousPremiumRateString
                                        defaultRegion:@"CX"
  ...
  XCTAssertTrue([_shortNumberUtil isValidShortNumber:[_phoneNumberUtil parse:ambiguousStandardRateString
                                       defaultRegion:@"AU"
                                               error:nil] forRegion:@"AU"]);
  XCTAssertEqual(NBEShortNumberCostStandardRate,
      [_shortNumberUtil expectedCostOfPhoneNumber:[_phoneNumberUtil parse:ambiguousStandardRateString
                                    defaultRegion:@"AU"
                                            error:nil] forRegion:@"AU"]);
  XCTAssertFalse([_shortNumberUtil isValidShortNumber:[_phoneNumberUtil parse:ambiguousStandardRateString
                                        defaultRegion:@"CX"
                                                error:nil] forRegion:@"CX"]);
  XCTAssertEqual(NBEShortNumberCostUnknown,
      [_shortNumberUtil expectedCostOfPhoneNumber:[_phoneNumberUtil parse:ambiguousStandardRateString
  ...
  XCTAssertEqual(NBEShortNumberCostTollFree,
      [_shortNumberUtil expectedCostOfPhoneNumber:[_phoneNumberUtil parse:ambiguousTollFreeString
                                    defaultRegion:@"AU"
                                            error:nil] forRegion:@"AU"]);
  XCTAssertFalse([_shortNumberUtil isValidShortNumber:[_phoneNumberUtil parse:ambiguousTollFreeString
                                        defaultRegion:@"CX"
                                                error:nil] forRegion:@"CX"]);
  XCTAssertEqual(NBEShortNumberCostUnknown,
      [_shortNumberUtil expectedCostOfPhoneNumber:[_phoneNumberUtil parse:ambiguousTollFreeString
...
- (void)testGetExampleShortNumberForCost {
  ...
  XCTAssertEqualObjects(@"15", [_testHelper exampleShortNumberForCost:NBEShortNumberCostTollFree
                                                      regionCode:@"FR"]);
  XCTAssertEqualObjects(@"611", [_testHelper exampleShortNumberForCost:NBEShortNumberCostStandardRate
                                                      regionCode:@"FR"]);
  XCTAssertEqualObjects(@"36665", [_testHelper exampleShortNumberForCost:NBEShortNumberCostPremiumRate
                                                      regionCode:@"FR"]);
...
- (void)testConnectsToEmergencyNumberLongNumber_US {
  ...
  XCTAssertTrue([_shortNumberUtil connectsToEmergencyNumberFromString:@"9116666666" forRegion:@"US"]);
  XCTAssertTrue([_shortNumberUtil connectsToEmergencyNumberFromString:@"1126666666" forRegion:@"US"]);
  XCTAssertFalse([_shortNumberUtil connectsToEmergencyNumberFromString:@"9996666666" forRegion:@"US"]);
}
...
- (void)testConnectsToEmergencyNumber_AO {
  ...
  XCTAssertFalse([_shortNumberUtil connectsToEmergencyNumberFromString:@"222123456" forRegion:@"AO"]);
  XCTAssertFalse([_shortNumberUtil connectsToEmergencyNumberFromString:@"923123456" forRegion:@"AO"]);
}
...
- (void)testConnectsToEmergencyNumber_ZW {
  ...
  XCTAssertFalse([_shortNumberUtil connectsToEmergencyNumberFromString:@"01312345" forRegion:@"ZW"]);
  XCTAssertFalse([_shortNumberUtil connectsToEmergencyNumberFromString:@"0711234567" forRegion:@"ZW"]);
}
...
- (void)testOverlappingNANPANumber {
  ...
  XCTAssertEqual(NBEShortNumberCostTollFree,
      [_shortNumberUtil expectedCostOfPhoneNumber:bb211 forRegion:@"BB"]);
  XCTAssertFalse([_shortNumberUtil isEmergencyNumber:@"211" forRegion:@"US"]);
  XCTAssertEqual(NBEShortNumberCostUnknown,
      [_shortNumberUtil expectedCostOfPhoneNumber:us211 forRegion:@"US"]);
  XCTAssertFalse([_shortNumberUtil isEmergencyNumber:@"211" forRegion:@"CA"]);
  XCTAssertEqual(NBEShortNumberCostTollFree,
      [_shortNumberUtil expectedCostOfPhoneNumber:ca211 forRegion:@"CA"]);
}
...
- (void)testCountryCallingCodeIsNotIgnored {
  ...
  XCTAssertEqual(NBEShortNumberCostUnknown,
      [_shortNumberUtil expectedCostOfPhoneNumber:seNumber forRegion:@"US"]);
}
