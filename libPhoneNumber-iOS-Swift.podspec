Pod::Spec.new do |s|
  ...
  s.dependency 'libPhoneNumber-iOS-SwiftCore', '~> 1.7.5'
  s.dependency 'libPhoneNumber-iOS-SwiftGeocoding', '~> 1.7.5'
  s.dependency 'libPhoneNumber-iOS-SwiftShortNumber', '~> 1.7.5'
