Pod::Spec.new do |s|
  ...
  s.dependency 'libPhoneNumber-iOS-SwiftCore', '~> 2.0.0'
  s.dependency 'libPhoneNumber-iOS-SwiftGeocoding', '~> 2.0.0'
  s.dependency 'libPhoneNumber-iOS-SwiftShortNumber', '~> 2.0.0'
