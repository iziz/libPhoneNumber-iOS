...
- (void)testGetLengthOfNationalDestinationCode {
  ...
  XCTAssertEqual(0,
                 [_aUtil getLengthOfNationalDestinationCode:self.usShortByOneNumber]);
...
- (void)testGetNationalSignificantNumber {
  ...
  XCTAssertEqualObjects(@"12345678", [_aUtil getNationalSignificantNumber:self.internationalTollFreeNumber]);
}

- (void)testGetExampleNumber {
  XCTAssertTrue([self.deNumber isEqual:[_aUtil getExampleNumber:@"DE" error:nil]]);
  
  XCTAssertTrue([self.deNumber isEqual:[_aUtil getExampleNumberForType:@"DE" type:NBEPhoneNumberTypeFIXED_LINE error:nil]]);
  XCTAssertTrue([self.deNumber isEqual:[_aUtil getExampleNumberForType:@"DE" type:NBEPhoneNumberTypeFIXED_LINE_OR_MOBILE error:nil]]);
...
- (void)testexampleNumberForNonGeoEntity {
  XCTAssertTrue([self.internationalTollFreeNumber isEqual:[_aUtil getExampleNumberForNonGeoEntity:@800 error:nil]]);
  XCTAssertTrue([self.universalPremiumRateNumber isEqual:[_aUtil getExampleNumberForNonGeoEntity:@979 error:nil]]);
}
...
- (void)testFormatUSNumber {
  XCTAssertEqualObjects(@"650 253 0000", [_aUtil format:self.usNumber numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+1 650 253 0000", [_aUtil format:self.usNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"800 253 0000", [_aUtil format:self.usTollFreeNumber numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+1 800 253 0000", [_aUtil format:self.usTollFreeNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"900 253 0000", [_aUtil format:self.usPremiumNumber numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+1 900 253 0000", [_aUtil format:self.usPremiumNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"tel:+1-900-253-0000", [_aUtil format:self.usPremiumNumber numberFormat:NBEPhoneNumberFormatRFC3966]);
  ...
  XCTAssertEqualObjects(@"000-000-0000", [_aUtil format:usSpoofWithRawInput numberFormat:NBEPhoneNumberFormatNATIONAL]);
...
- (void)testFormatBSNumber {
  XCTAssertEqualObjects(@"242 365 1234", [_aUtil format:self.bsNumber numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+1 242 365 1234", [_aUtil format:self.bsNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
}

- (void)testFormatGBNumber {
  NBPhoneNumber *gbNumber = self.gbNumber;
  XCTAssertEqualObjects(@"(020) 7031 3000", [_aUtil format:gbNumber numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+44 20 7031 3000", [_aUtil format:gbNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"(07912) 345 678", [_aUtil format:self.gbMobile numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+44 7912 345 678", [_aUtil format:self.gbMobile numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
}
...
- (void)testFormatDENumber {
  ...
  XCTAssertEqualObjects(@"1234", [_aUtil format:self.deShortNumber numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+49 1234", [_aUtil format:self.deShortNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
...
- (void)testFormatITNumber {
  XCTAssertEqualObjects(@"02 3661 8300", [_aUtil format:self.itNumber numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+39 02 3661 8300", [_aUtil format:self.itNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"+390236618300", [_aUtil format:self.itNumber numberFormat:NBEPhoneNumberFormatE164]);
  XCTAssertEqualObjects(@"345 678 901", [_aUtil format:self.itMobile numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+39 345 678 901", [_aUtil format:self.itMobile numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"+39345678901", [_aUtil format:self.itMobile numberFormat:NBEPhoneNumberFormatE164]);
}

- (void)testFormatAUNumber {
  XCTAssertEqualObjects(@"02 3661 8300", [_aUtil format:self.auNumber numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+61 2 3661 8300", [_aUtil format:self.auNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"+61236618300", [_aUtil format:self.auNumber numberFormat:NBEPhoneNumberFormatE164]);
...
- (void)testFormatARNumber {
  XCTAssertEqualObjects(@"011 8765-4321", [_aUtil format:self.arNumber numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+54 11 8765-4321", [_aUtil format:self.arNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"+541187654321", [_aUtil format:self.arNumber numberFormat:NBEPhoneNumberFormatE164]);
  XCTAssertEqualObjects(@"011 15 8765-4321", [_aUtil format:self.arMobile numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+54 9 11 8765 4321", [_aUtil format:self.arMobile numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"+5491187654321", [_aUtil format:self.arMobile numberFormat:NBEPhoneNumberFormatE164]);
}
...
- (void)testFormatMXNumber {
  ...
  XCTAssertEqualObjects(@"045 234 567 8900", [_aUtil format:mxMobile1 numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+52 1 234 567 8900", [_aUtil format:mxMobile1 numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"+5212345678900", [_aUtil format:mxMobile1 numberFormat:NBEPhoneNumberFormatE164]);
  NBPhoneNumber *mxMobile2 = [[NBPhoneNumber alloc] init];
  mxMobile2.countryCode = @52;
  mxMobile2.nationalNumber = @15512345678;
  XCTAssertEqualObjects(@"045 55 1234 5678", [_aUtil format:mxMobile2 numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+52 1 55 1234 5678", [_aUtil format:mxMobile2 numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"+5215512345678", [_aUtil format:mxMobile2 numberFormat:NBEPhoneNumberFormatE164]);
  XCTAssertEqualObjects(@"01 33 1234 5678", [_aUtil format:self.mxNumber numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+52 33 1234 5678", [_aUtil format:self.mxNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"+523312345678", [_aUtil format:self.mxNumber numberFormat:NBEPhoneNumberFormatE164]);
  NBPhoneNumber *mxNumber2 = [[NBPhoneNumber alloc] init];
  mxNumber2.countryCode = @52;
  mxNumber2.nationalNumber = @8211234567;
  XCTAssertEqualObjects(@"01 821 123 4567", [_aUtil format:mxNumber2 numberFormat:NBEPhoneNumberFormatNATIONAL]);
  XCTAssertEqualObjects(@"+52 821 123 4567", [_aUtil format:mxNumber2 numberFormat:NBEPhoneNumberFormatINTERNATIONAL]);
  XCTAssertEqualObjects(@"+528211234567", [_aUtil format:mxNumber2 numberFormat:NBEPhoneNumberFormatE164]);
}

- (void)testFormatOutOfCountryCallingNumber {
  XCTAssertEqualObjects(@"00 1 900 253 0000", [_aUtil formatOutOfCountryCallingNumber:self.usPremiumNumber regionCallingFrom:@"DE"]);
  XCTAssertEqualObjects(@"1 650 253 0000", [_aUtil formatOutOfCountryCallingNumber:self.usNumber regionCallingFrom:@"BS"]);
  XCTAssertEqualObjects(@"00 1 650 253 0000", [_aUtil formatOutOfCountryCallingNumber:self.usNumber regionCallingFrom:@"PL"]);
  XCTAssertEqualObjects(@"011 44 7912 345 678", [_aUtil formatOutOfCountryCallingNumber:self.gbMobile regionCallingFrom:@"US"]);
  XCTAssertEqualObjects(@"00 49 1234", [_aUtil formatOutOfCountryCallingNumber:self.deShortNumber regionCallingFrom:@"GB"]);
  // Note this number is correctly formatted without national prefix. Most of
  // the numbers that are treated as invalid numbers by the library are short
  // numbers, and they are usually not dialed with national prefix.
  XCTAssertEqualObjects(@"1234", [_aUtil formatOutOfCountryCallingNumber:self.deShortNumber regionCallingFrom:@"DE"]);
  XCTAssertEqualObjects(@"011 39 02 3661 8300", [_aUtil formatOutOfCountryCallingNumber:self.itNumber regionCallingFrom:@"US"]);
  XCTAssertEqualObjects(@"02 3661 8300", [_aUtil formatOutOfCountryCallingNumber:self.itNumber regionCallingFrom:@"IT"]);
  XCTAssertEqualObjects(@"+39 02 3661 8300", [_aUtil formatOutOfCountryCallingNumber:self.itNumber regionCallingFrom:@"SG"]);
  XCTAssertEqualObjects(@"6521 8000", [_aUtil formatOutOfCountryCallingNumber:self.sgNumber regionCallingFrom:@"SG"]);
  XCTAssertEqualObjects(@"011 54 9 11 8765 4321", [_aUtil formatOutOfCountryCallingNumber:self.arMobile regionCallingFrom:@"US"]);
  XCTAssertEqualObjects(@"011 800 1234 5678", [_aUtil formatOutOfCountryCallingNumber:self.internationalTollFreeNumber regionCallingFrom:@"US"]);
...
- (void)testFormatOutOfCountryWithInvalidRegion {
  ...
  XCTAssertEqualObjects(@"+1 650 253 0000", [_aUtil formatOutOfCountryCallingNumber:self.usNumber regionCallingFrom:@"AQ"]);
  // For region code 001, the out-of-country format always turns into the
  // international format.
  XCTAssertEqualObjects(@"+1 650 253 0000", [_aUtil formatOutOfCountryCallingNumber:self.usNumber regionCallingFrom:@"001"]);
}
...
- (void)testFormatOutOfCountryWithPreferredIntlPrefix {
  ...
  // test metadta.)
  XCTAssertEqualObjects(@"0011 39 02 3661 8300", [_aUtil formatOutOfCountryCallingNumber:self.itNumber regionCallingFrom:@"AU"]);
}
...
- (void)testFormatWithCarrierCod {
  ...
  XCTAssertEqualObjects(@"650 253 0000", [_aUtil formatNationalNumberWithCarrierCode:self.usNumber carrierCode:@"15"]);
  // Invalid country code should just get the NSN.
  XCTAssertEqualObjects(@"12345", [_aUtil formatNationalNumberWithCarrierCode:self.unknownCountryCodeNoRawInput carrierCode:@"89"]);
}
...
- (void)testFormatNumberForMobileDialing {
  ...
  XCTAssertEqualObjects(@"030123456", [_aUtil formatNumberForMobileDialing:self.deNumber regionCallingFrom:@"DE" withFormatting:NO]);
  XCTAssertEqualObjects(@"+4930123456", [_aUtil formatNumberForMobileDialing:self.deNumber regionCallingFrom:@"CH" withFormatting:NO]);
  ...
  XCTAssertEqualObjects(@"800 253 0000", [_aUtil formatNumberForMobileDialing:self.usTollFreeNumber regionCallingFrom:@"US" withFormatting:YES]);
  XCTAssertEqualObjects(@"", [_aUtil formatNumberForMobileDialing:self.usTollFreeNumber regionCallingFrom:@"CN" withFormatting:YES]);
  XCTAssertEqualObjects(@"+1 650 253 0000", [_aUtil formatNumberForMobileDialing:self.usNumber regionCallingFrom:@"US" withFormatting:YES]);
  ...
  XCTAssertEqualObjects(@"8002530000", [_aUtil formatNumberForMobileDialing:self.usTollFreeNumber regionCallingFrom:@"US" withFormatting:NO]);
  XCTAssertEqualObjects(@"", [_aUtil formatNumberForMobileDialing:self.usTollFreeNumber regionCallingFrom:@"CN" withFormatting:NO]);
  XCTAssertEqualObjects(@"+16502530000", [_aUtil formatNumberForMobileDialing:self.usNumber regionCallingFrom:@"US" withFormatting:NO]);
  ...
  XCTAssertEqualObjects(@"+165025300001", [_aUtil formatNumberForMobileDialing:self.usTooLongNumber regionCallingFrom:@"US" withFormatting:NO]);
  XCTAssertEqualObjects(@"+1 65025300001", [_aUtil formatNumberForMobileDialing:self.usTooLongNumber regionCallingFrom:@"US" withFormatting:YES]);
  ...
  XCTAssertEqualObjects(@"*2345", [_aUtil formatNumberForMobileDialing:jpStarNumber regionCallingFrom:@"JP" withFormatting:NO]);
  XCTAssertEqualObjects(@"*2345", [_aUtil formatNumberForMobileDialing:jpStarNumber regionCallingFrom:@"JP" withFormatting:YES]);
  XCTAssertEqualObjects(@"+80012345678", [_aUtil formatNumberForMobileDialing:self.internationalTollFreeNumber regionCallingFrom:@"JP" withFormatting:NO]);
  XCTAssertEqualObjects(@"+800 1234 5678", [_aUtil formatNumberForMobileDialing:self.internationalTollFreeNumber regionCallingFrom:@"JP" withFormatting:YES]);
  ...
  XCTAssertEqualObjects(@"+971600123456", [_aUtil formatNumberForMobileDialing:aeUAN regionCallingFrom:@"JP" withFormatting:NO]);
  XCTAssertEqualObjects(@"600123456", [_aUtil formatNumberForMobileDialing:aeUAN regionCallingFrom:@"AE" withFormatting:NO]);
  XCTAssertEqualObjects(@"+523312345678",
                        [_aUtil formatNumberForMobileDialing:self.mxNumber regionCallingFrom:@"MX" withFormatting:NO]);
  XCTAssertEqualObjects(@"+523312345678",
                        [_aUtil formatNumberForMobileDialing:self.mxNumber regionCallingFrom:@"US" withFormatting:NO]);
  
  // Non-geographical numbers should always be dialed in international format.
  XCTAssertEqualObjects(@"+80012345678", [_aUtil formatNumberForMobileDialing:self.internationalTollFreeNumber regionCallingFrom:@"US" withFormatting:NO]);
  XCTAssertEqualObjects(@"+80012345678", [_aUtil formatNumberForMobileDialing:self.internationalTollFreeNumber regionCallingFrom:@"UN001" withFormatting:NO]);
...
- (void)testFormatByPattern {
  ...
  XCTAssertEqualObjects(@"(650) 253-0000", [_aUtil formatByPattern:self.usNumber numberFormat:NBEPhoneNumberFormatNATIONAL userDefinedFormats:@[newNumFormat]]);
  
  XCTAssertEqualObjects(@"+1 (650) 253-0000", [_aUtil formatByPattern:self.usNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL userDefinedFormats:@[newNumFormat]]);
  XCTAssertEqualObjects(@"tel:+1-650-253-0000", [_aUtil formatByPattern:self.usNumber numberFormat:NBEPhoneNumberFormatRFC3966 userDefinedFormats:@[newNumFormat]]);
  
  // $NP is set to '1' for the US. Here we check that for other NANPA countries
  // the US rules are followed.
  [newNumFormat setNationalPrefixFormattingRule:@"$NP ($FG)"];
  [newNumFormat setFormat:@"$1 $2-$3"];
  XCTAssertEqualObjects(@"1 (242) 365-1234", [_aUtil formatByPattern:self.bsNumber numberFormat:NBEPhoneNumberFormatNATIONAL userDefinedFormats:@[newNumFormat]]);
  XCTAssertEqualObjects(@"+1 242 365-1234", [_aUtil formatByPattern:self.bsNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL userDefinedFormats:@[newNumFormat]]);
  
  [newNumFormat setPattern:@"(\\d{2})(\\d{5})(\\d{3})"];
  [newNumFormat setFormat:@"$1-$2 $3"];
  
  XCTAssertEqualObjects(@"02-36618 300", [_aUtil formatByPattern:self.itNumber numberFormat:NBEPhoneNumberFormatNATIONAL userDefinedFormats:@[newNumFormat]]);
  XCTAssertEqualObjects(@"+39 02-36618 300", [_aUtil formatByPattern:self.itNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL userDefinedFormats:@[newNumFormat]]);
  
  [newNumFormat setNationalPrefixFormattingRule:@"$NP$FG"];
  [newNumFormat setPattern:@"(\\d{2})(\\d{4})(\\d{4})"];
  [newNumFormat setFormat:@"$1 $2 $3"];
  NBPhoneNumber *gbNumber = self.gbNumber;
  XCTAssertEqualObjects(@"020 7031 3000", [_aUtil formatByPattern:gbNumber numberFormat:NBEPhoneNumberFormatNATIONAL userDefinedFormats:@[newNumFormat]]);
  
  [newNumFormat setNationalPrefixFormattingRule:@"($NP$FG)"];
  XCTAssertEqualObjects(@"(020) 7031 3000", [_aUtil formatByPattern:gbNumber numberFormat:NBEPhoneNumberFormatNATIONAL userDefinedFormats:@[newNumFormat]]);
  
  [newNumFormat setNationalPrefixFormattingRule:@""];
  XCTAssertEqualObjects(@"20 7031 3000", [_aUtil formatByPattern:gbNumber numberFormat:NBEPhoneNumberFormatNATIONAL userDefinedFormats:@[newNumFormat]]);
  XCTAssertEqualObjects(@"+44 20 7031 3000", [_aUtil formatByPattern:gbNumber numberFormat:NBEPhoneNumberFormatINTERNATIONAL userDefinedFormats:@[newNumFormat]]);
}

- (void)testFormatE164Number {
  XCTAssertEqualObjects(@"+16502530000", [_aUtil format:self.usNumber numberFormat:NBEPhoneNumberFormatE164]);
  XCTAssertEqualObjects(@"+4930123456", [_aUtil format:self.deNumber numberFormat:NBEPhoneNumberFormatE164]);
  XCTAssertEqualObjects(@"+80012345678", [_aUtil format:self.internationalTollFreeNumber numberFormat:NBEPhoneNumberFormatE164]);
}
...
- (void)testFormatInOriginalFormat {
  ...
  // national number.
  XCTAssertEqualObjects(@"650253000", [_aUtil formatInOriginalFormat:self.usShortByOneNumber regionCallingFrom:@"US"]);
}
...
- (void)testIsPremiumRate {
  ...
  XCTAssertEqual(NBEPhoneNumberTypePREMIUM_RATE, [_aUtil getNumberType:premiumRateNumber]);
  XCTAssertEqual(NBEPhoneNumberTypePREMIUM_RATE, [_aUtil getNumberType:self.universalPremiumRateNumber]);
}
...
- (void)testIsTollFree {
  ...
  XCTAssertEqual(NBEPhoneNumberTypeTOLL_FREE, [_aUtil getNumberType:self.internationalTollFreeNumber]);
}
...
- (void)testIsValidForRegion {
  ...
  XCTAssertFalse([_aUtil isValidNumberForRegion:self.internationalTollFreeNumber regionCode:NB_UNKNOWN_REGION]);
...
- (void)testIsPossibleNumberWithReason {
  ...
  XCTAssertEqual(NBEValidationResultIS_POSSIBLE, [_aUtil isPossibleNumberWithReason:self.usLocalNumber]);
  XCTAssertEqual(NBEValidationResultTOO_LONG, [_aUtil isPossibleNumberWithReason:self.usTooLongNumber]);
  ...
  XCTAssertEqual(NBEValidationResultTOO_LONG, [_aUtil isPossibleNumberWithReason:self.internationalTollFreeTooLongNumber]);
}
...
- (void)testParseNationalNumber {
  ...
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"033316005" defaultRegion:@"NZ" error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"33316005" defaultRegion:@"NZ" error:&anError]]);
  
  // National prefix attached and some formatting present.
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"03-331 6005" defaultRegion:@"NZ" error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"03 331 6005" defaultRegion:@"NZ" error:&anError]]);
  
  // Test parsing RFC3966 format with a phone context.
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"tel:03-331-6005;phone-context=+64" defaultRegion:@"NZ" error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"tel:331-6005;phone-context=+64-3" defaultRegion:@"NZ" error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"tel:331-6005;phone-context=+64-3" defaultRegion:@"US" error:&anError]]);
  
  // Test parsing RFC3966 format with optional user-defined parameters. The
  // parameters will appear after the context if present.
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"tel:03-331-6005;phone-context=+64;a=%A1" defaultRegion:@"NZ" error:&anError]]);
  
  // Test parsing RFC3966 with an ISDN subaddress.
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"tel:03-331-6005;isub=12345;phone-context=+64" defaultRegion:@"NZ" error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"tel:+64-3-331-6005;isub=12345" defaultRegion:@"NZ" error:&anError]]);
  
  // Testing international prefixes.
  // Should strip country calling code.
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"0064 3 331 6005" defaultRegion:@"NZ" error:&anError]]);
  ...
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"01164 3 331 6005" defaultRegion:@"US" error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"+64 3 331 6005" defaultRegion:@"US" error:&anError]]);
  ...
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"+01164 3 331 6005" defaultRegion:@"US" error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"+0064 3 331 6005" defaultRegion:@"NZ" error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"+ 00 64 3 331 6005" defaultRegion:@"NZ" error:&anError]]);
  
  XCTAssertTrue([self.usLocalNumber isEqual:[_aUtil parse:@"tel:253-0000;phone-context=www.google.com" defaultRegion:@"US" error:&anError]]);
  XCTAssertTrue([self.usLocalNumber isEqual:[_aUtil parse:@"tel:253-0000;isub=12345;phone-context=www.google.com" defaultRegion:@"US" error:&anError]]);
  ...
  // domain.
  XCTAssertTrue([self.usLocalNumber isEqual:[_aUtil parse:@"tel:2530000;isub=12345;phone-context=1-650" defaultRegion:@"US" error:&anError]]);
  XCTAssertTrue([self.usLocalNumber isEqual:[_aUtil parse:@"tel:2530000;isub=12345;phone-context=1234.com" defaultRegion:@"US" error:&anError]]);
  ...
  XCTAssertTrue([self.deNumber isEqual:[_aUtil parse:@"301/23456" defaultRegion:@"DE" error:&anError]]);
  ...
  jpStarNumber.countryCode = @81;
  jpStarNumber.nationalNumber = @2345;
  XCTAssertTrue([jpStarNumber isEqual:[_aUtil parse:@"+81 *2345" defaultRegion:@"JP" error:&anError]]);
...
- (void)testParseWithInternationalPrefixes {
  NSError *anError = nil;
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"+1 (650) 253-0000" defaultRegion:@"NZ" error:&anError]]);
  XCTAssertTrue([self.internationalTollFreeNumber isEqual:[_aUtil parse:@"011 800 1234 5678" defaultRegion:@"US" error:&anError]]);
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"1-650-253-0000" defaultRegion:@"US" error:&anError]]);
  // Calling the US number from Singapore by using different service providers
  // 1st test: calling using SingTel IDD service (IDD is 001)
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"0011-650-253-0000" defaultRegion:@"SG" error:&anError]]);
  // 2nd test: calling using StarHub IDD service (IDD is 008)
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"0081-650-253-0000" defaultRegion:@"SG" error:&anError]]);
  // 3rd test: calling using SingTel V019 service (IDD is 019)
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"0191-650-253-0000" defaultRegion:@"SG" error:&anError]]);
  // Calling the US number from Poland
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"0~01-650-253-0000" defaultRegion:@"PL" error:&anError]]);
  // Using '++' at the start.
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"++1 (650) 253-0000" defaultRegion:@"PL" error:&anError]]);
}
...
- (void)testParseNonAscii {
  ...
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"\uFF0B1 (650) 253-0000" defaultRegion:@"SG" error:&anError]]);
  // Using a soft hyphen U+00AD.
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"1 (650) 253\u00AD-0000" defaultRegion:@"US" error:&anError]]);
  // The whole number, including punctuation, is here represented in full-width
  // form.
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"\uFF0B\uFF11\u3000\uFF08\uFF16\uFF15\uFF10\uFF09\u3000\uFF12\uFF15\uFF13\uFF0D\uFF10\uFF10\uFF10\uFF10" defaultRegion:@"SG" error:&anError]]);
  // Using U+30FC dash instead.
  XCTAssertTrue([self.usNumber isEqual:[_aUtil parse:@"\uFF0B\uFF11\u3000\uFF08\uFF16\uFF15\uFF10\uFF09\u3000\uFF12\uFF15\uFF13\u30FC\uFF10\uFF10\uFF10\uFF10" defaultRegion:@"SG" error:&anError]]);
...
- (void)testParseWithLeadingZero {
  NSError *anError = nil;
  XCTAssertTrue([self.itNumber isEqual:[_aUtil parse:@"+39 02-36618 300" defaultRegion:@"NZ" error:&anError]]);
  XCTAssertTrue([self.itNumber isEqual:[_aUtil parse:@"02-36618 300" defaultRegion:@"IT" error:&anError]]);
  XCTAssertTrue([self.itMobile isEqual:[_aUtil parse:@"345 678 901" defaultRegion:@"IT" error:&anError]]);
}
...
- (void)testParseNationalNumberArgentina {
  ...
  XCTAssertTrue([self.arMobile isEqual:[_aUtil parse:@"911 876 54321" defaultRegion:@"AR" error:&anError]]);
  
  // Test parsing fixed-line numbers of Argentina.
  XCTAssertTrue([self.arNumber isEqual:[_aUtil parse:@"+54 11 8765 4321" defaultRegion:@"AR" error:&anError]]);
  XCTAssertTrue([self.arNumber isEqual:[_aUtil parse:@"011 8765 4321" defaultRegion:@"AR" error:&anError]]);
...
- (void)testParseWithXInNumber {
  ...
  // just gets removed.
  XCTAssertTrue([self.arNumber isEqual:[_aUtil parse:@"01187654321" defaultRegion:@"AR" error:&anError]]);
  XCTAssertTrue([self.arNumber isEqual:[_aUtil parse:@"(0) 1187654321" defaultRegion:@"AR" error:&anError]]);
  XCTAssertTrue([self.arNumber isEqual:[_aUtil parse:@"0 1187654321" defaultRegion:@"AR" error:&anError]]);
  XCTAssertTrue([self.arNumber isEqual:[_aUtil parse:@"(0xx) 1187654321" defaultRegion:@"AR" error:&anError]]);
...
- (void)testParseNumbersWithPlusWithNoRegion {
  ...
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"+64 3 331 6005" defaultRegion:NB_UNKNOWN_REGION error:&anError]]);
  // Test with full-width plus.
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"\uFF0B64 3 331 6005" defaultRegion:NB_UNKNOWN_REGION error:&anError]]);
  // Test with normal plus but leading characters that need to be stripped.
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"Tel: +64 3 331 6005" defaultRegion:NB_UNKNOWN_REGION error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"+64 3 331 6005" defaultRegion:nil error:&anError]]);
  XCTAssertTrue([self.internationalTollFreeNumber isEqual:[_aUtil parse:@"+800 1234 5678" defaultRegion:nil error:&anError]]);
  XCTAssertTrue([self.universalPremiumRateNumber isEqual:[_aUtil parse:@"+979 123 456 789" defaultRegion:nil error:&anError]]);
  
  // Test parsing RFC3966 format with a phone context.
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"tel:03-331-6005;phone-context=+64" defaultRegion:NB_UNKNOWN_REGION error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"  tel:03-331-6005;phone-context=+64" defaultRegion:NB_UNKNOWN_REGION error:&anError]]);
  XCTAssertTrue([self.nzNumber isEqual:[_aUtil parse:@"tel:03-331-6005;isub=12345;phone-context=+64" defaultRegion:NB_UNKNOWN_REGION error:&anError]]);
...
- (void)testParseExtensions {
  ...
  XCTAssertTrue([self.alphaNumbericNumber isEqual:[_aUtil parse:@"1800 six-flags" defaultRegion:@"US" error:&anError]]);
  XCTAssertTrue([self.alphaNumbericNumber isEqual:[_aUtil parse:@"1800 SIX FLAGS" defaultRegion:@"US" error:&anError]]);
  XCTAssertTrue([self.alphaNumbericNumber isEqual:[_aUtil parse:@"0~0 1800 7493 5247" defaultRegion:@"PL" error:&anError]]);
  XCTAssertTrue([self.alphaNumbericNumber isEqual:[_aUtil parse:@"(1800) 7493.5247" defaultRegion:@"US" error:&anError]]);
...
- (void)testCountryWithNoNumberDesc {
  ...
  XCTAssertEqualObjects(@"00 1 650 253 0000", [_aUtil formatOutOfCountryCallingNumber:self.usNumber regionCallingFrom:@"AD"]);
}
...
- (void)testUnknownCountryCallingCode {
  ...
  XCTAssertEqualObjects(@"+212345", [_aUtil format:self.unknownCountryCodeNoRawInput numberFormat:NBEPhoneNumberFormatE164]);
}
...
- (void)testIsNumberMatchMatches {
  ...
  // Test proto buffers.
  XCTAssertEqual(NBEMatchTypeEXACT_MATCH, [_aUtil isNumberMatch:self.nzNumber second:@"+6403 331 6005"]);
  ...
  XCTAssertEqual(NBEMatchTypeEXACT_MATCH, [_aUtil isNumberMatch:nzNumber second:self.nzNumber], @"Numbers did not match");
...
- (void)testIsNumberMatchNsnMatches {
  ...
  XCTAssertEqual(NBEMatchTypeNSN_MATCH, [_aUtil isNumberMatch:self.usNumber second:@"1-650-253-0000"]);
