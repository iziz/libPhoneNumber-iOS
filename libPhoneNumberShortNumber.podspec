...
DESC
  ...
  s.authors      = { "rastaarh" => "rastaar@google.com"}
  ...
  s.source_files = 'libPhoneNumberShortNumber/NBShortNumberUtil.{h,m}', 'libPhoneNumberShortNumber/NBShortNumberMetadataHelper.{h,m}'
end
